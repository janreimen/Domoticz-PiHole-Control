...
Idea based on abandoned plugin by [Xorfor] (https://forum.domoticz.com/viewtopic.php?t=20834) and worked on by [YoYo] (https://github.com/voyo/Domoticz_PiHole-Control/)
...
```bash
cd ~/domoticz/plugins
git clone https://github.com/janreimen/Domoticz-PiHole-Control.git PiHole-HTTPS
restart domoticz
```
...
3. Fill in:
   ...
   - **Certificate Chain Path** : the full File Path to your chain.pem (RootCA, SubCA if existing), i.e. /srv/domoticz/chain.pem
