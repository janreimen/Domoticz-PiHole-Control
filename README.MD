...
Idea based on abandoned plugin by [Xorfor] (https://forum.domoticz.com/viewtopic.php?t=20834) and worked on by [Voyo] (https://github.com/voyo/Domoticz_PiHole-Control/)
